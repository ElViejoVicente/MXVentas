...
{
    public partial class frmRptTiposPago : Telerik.WinControls.UI.RadForm
    {
        private static frmRptTiposPago m_FormDefInstance;
        public static frmRptTiposPago DefInstance
        {
            get
            {

                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmRptTiposPago();
                return m_FormDefInstance;
            }
            set { m_FormDefInstance = value; }
        }
        public frmRptTiposPago()
        {
            InitializeComponent();
        }
        string filtroSQL = "";
        string DescFiltro = ""; 
        private void frmRptTiposPago_Load(object sender, EventArgs e)
        {
            Encabezados();
            ReadData();
        }
        private void Encabezados()
        {
            ...
            lvRpt.Columns.Add("Tipo de Pago", 200, HorizontalAlignment.Left);

            lvRpt.Columns.Add("Total", 150, HorizontalAlignment.Right);
        ...
        private void FiltroSQL()
        {
            ...
            {
                /*
                 "SELECT SUM((PRECIO_VENTA * CANTIDAD))AS VENTAS,TIPO_PAGO " +
                ...
                if (varFILTRO)
                {
                    ...
                    if (varFILTRO_HOY)
                    {
                        ...
                        filtroSQL = "SELECT SUM((PRECIO_VENTA * CANTIDAD))AS TOTAL,TIPO_PAGO " +
                        " FROM VENTA INNER JOIN VENTA_DETALLE ON VENTA.FOLIO = VENTA_DETALLE.FOLIO " +
                        " WHERE VENTA.FECHA BETWEEN #" + ISODates.MSAccessDateINI(DateTime.Now) + "# AND #" + ISODates.MSAccessDateFIN(DateTime.Now) + "# GROUP BY TIPO_PAGO";
                    ...
                    else
                    {
                        ...
                        filtroSQL = "SELECT SUM((PRECIO_VENTA * CANTIDAD))AS TOTAL,TIPO_PAGO " +
                        " FROM VENTA INNER JOIN VENTA_DETALLE ON VENTA.FOLIO = VENTA_DETALLE.FOLIO " +
                        " WHERE VENTA.FECHA BETWEEN #" + ISODates.MSAccessDateINI(varFECHA_INI) + "# AND #" + ISODates.MSAccessDateFIN(varFECHA_FIN) + "# GROUP BY TIPO_PAGO";
                    }
                }
                else
                {
                    ...
                    DescFiltro = "(TODO)";
                    filtroSQL  = "SELECT SUM((PRECIO_VENTA * CANTIDAD))AS TOTAL,TIPO_PAGO " +
                        " FROM VENTA INNER JOIN VENTA_DETALLE ON VENTA.FOLIO = VENTA_DETALLE.FOLIO GROUP BY TIPO_PAGO ";
                }
            }
            catch (Exception ex)
            {
        ...
        private void ReadData()
        {
            ...
            try
            {
               ...
               cnnReadData.Open();
                ...
                {
                    lvRpt.Items.Add(drReadData["TIPO_PAGO"].ToString());
                ...
                //this.Text = "REPORTE DE TIPOS DE PAGO: " + I.ToString() + ", FILTRO: " + DescFiltro;
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            if (lvRpt.Items.Count != 0) {
                ...
                exportar.ExportToExcel(lvRpt, "TiposDePago");
            }
        }
