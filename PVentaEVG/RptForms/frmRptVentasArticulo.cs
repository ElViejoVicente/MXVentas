...
{
    public partial class frmRptVentasArticulo : Telerik.WinControls.UI.RadForm
    {
        private static frmRptVentasArticulo m_FormDefInstance;
        public static frmRptVentasArticulo DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmRptVentasArticulo();
                return m_FormDefInstance;
            }
            set { m_FormDefInstance = value; }
        }
        public frmRptVentasArticulo()
        {
            InitializeComponent();
        }
        ...
        private void Encabezados()
        {
            ...
            lvListaVentas.Columns.Add("Cant", 100, HorizontalAlignment.Right);
            lvListaVentas.Columns.Add("P.Venta", 100, HorizontalAlignment.Right);
            lvListaVentas.Columns.Add("Total", 100, HorizontalAlignment.Right);
            lvListaVentas.Columns.Add("Descuento", 100, HorizontalAlignment.Right);
            ...
            try
            {
                ...
                if (varFILTRO)
                {
                    ...
                    if (varFILTRO_HOY)
                    {
                        ...
                        filtroSQL = "SELECT VENTA_DETALLE.ID_PRODUCTO, CAT_PRODUCTO.DESC_PRODUCTO,SUM(CANTIDAD) AS CANTIDAD,VENTA_DETALLE.PRECIO_VENTA, " +
        ...
        private void ReadData()
        {
            ...
            try
            {
                ...
                while (drReadData.Read())
                {
                    ...
                    lvListaVentas.Items[I].SubItems.Add(String.Format("{0:C}", drReadData["PRECIO_VENTA"]));
        ...
        private void barListaVentas_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
